(function() {
    ...
    MaterialChipInput.prototype.addChip_ = function(text) {
        ...
        chip.classList = 'mdc-chip mdl-chip--deletable';
        chip.innerHTML =
            '<span class="mdc-chip__text">' + text + '</span>' +
            '<i class="mdc-chip__icon--trailing mdl-chip__action mdc-chip__action material-icons mdc-chip__icon mdc-chip__icon--leading" role="button">cancel</i>';
        ...
        this.parent_.insertBefore(chip, this.element_)
    ...
    MaterialChipInput.prototype.getChips = function() {
        ...
        for(var i = children.length; i--;) {
            if(children[i].classList.contains('mdc-chip')) {
